...
const showOnlyForRevisionCreate = {
	resource: ['revision'],
	operation: ['create'],
};

export const revisionCreateDescription: INodeProperties[] = [
	{
		...
		required: true,
		displayOptions: {
			show: showOnlyForRevisionCreate,
		},
	...
	},
	{
		...
		description: 'Internal name of the revision (max 100 characters)',
		routing: {
			send: {
				type: 'body',
				property: 'name',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Subtitle of the revision (max 1000 characters)',
				routing: {
					send: {
						type: 'body',
						property: 'subtitle',
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Title of the revision (max 1000 characters)',
				routing: {
					send: {
						type: 'body',
						property: 'title',
